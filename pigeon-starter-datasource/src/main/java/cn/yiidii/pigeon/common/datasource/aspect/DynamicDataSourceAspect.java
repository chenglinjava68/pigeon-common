package cn.yiidii.pigeon.common.datasource.aspect;

import cn.hutool.core.util.StrUtil;
import cn.yiidii.pigeon.common.core.base.R;
import cn.yiidii.pigeon.common.datasource.context.DynamicDataSourceContextHolder;
...
public class DynamicDataSourceAspect {
    ...
    @Around("execution(* cn.yiidii.*.*.controller.*.*(..))")
