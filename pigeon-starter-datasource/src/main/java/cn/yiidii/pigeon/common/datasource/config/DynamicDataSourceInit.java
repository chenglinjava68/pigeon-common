...
public class DynamicDataSourceInit {
    ...
    private List<TenantDatasource> getDatasource() {
        TenantDatasource ds01 = new TenantDatasource(1L, 1L, "com.mysql.cj.jdbc.Driver", "jdbc:mysql://127.0.0.1:3306/pigeon?useUnicode=true&characterEncoding=UTF-8&userSSL=false&serverTimezone=UTC", "root", "Wed114130");
        TenantDatasource ds02 = new TenantDatasource(2L, 2L, "com.mysql.cj.jdbc.Driver", "jdbc:mysql://yiidii.cn:3306/pigeon?useUnicode=true&characterEncoding=UTF-8&userSSL=false&serverTimezone=UTC", "root", "Wed114130");
